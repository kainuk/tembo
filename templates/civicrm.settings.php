...
$civicrm_paths['civicrm.files']['url'] = 'https://gef.ddev.site/sites/default/files/civicrm';
$civicrm_paths['civicrm.files']['path'] = '/var/www/html/web/sites/default/files/civicrm';
$civicrm_paths['civicrm.private']['path'] = '/var/www/html/web/sites/default/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://civicrm:civicrm@db/civicrm?new_link=true');
  }
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://gef.ddev.site');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '8b7UkTC1uAdys9N8VX4EKmMtp0nm2TfOBJ0kAaw');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:s6bsAZqehaaDMXSRC2IV1U9nRaH7iqRkKyKz0CfyBQaynZcDQ');
...
if (!defined('CIVICRM_DEPLOY_ID') ) {
  define( '_CIVICRM_DEPLOY_ID', 'uiTblmCpOmQ');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:Mp0gWHPVdNAs706amOHFGarptKY6kDPuAEBgF4s2tPiXlVd17OQ');
...
// define( 'CIVICRM_MAIL_LOG', '/home/gefeu/testcivi.gef.eu/web/sites/default/files/civicrm/templates_c/mail.log');
// }
